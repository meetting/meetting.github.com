function cityInit(obj_1,val_1,obj_2,val_2,obj_3,val_3){
	...
	//初始化
	$("<option value='请选择省份'>"+ar[0]+"</option>").appendTo($("#"+obj_1));
	$("<option value='请选择城市'>"+ar[1]+"</option>").appendTo($("#"+obj_2));
	$("<option value='请选择区县'>"+ar[2]+"</option>").appendTo($("#"+obj_3));
