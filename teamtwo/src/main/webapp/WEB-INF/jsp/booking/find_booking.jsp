...
<body>
    <div class="someinformation">
        <div class="pagemain">
            <div class="big1">
            <p class="tit">订单&nbsp/&nbsp查看订单</p>
            <hr>
            <c:if test="${not empty sessionScope.queryBookingResult}">
            <form action="#" method="post">
                <table style="text-align: center;">
                    ...
                    <c:forEach items="${sessionScope.queryBookingResult}" var="result" begin="0">
                    <tr>
                        <td >
                        ...
                        <td >
                            <a href="modifybookinginfo?orderid=${result.orderid }"><input type="button"value="修改"></a>
                        </td>
                    </tr>
                    </c:forEach>
                </table>
