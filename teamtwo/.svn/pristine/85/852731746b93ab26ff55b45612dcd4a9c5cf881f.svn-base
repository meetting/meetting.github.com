...
<body>
    ...
    <div class="someinformation">
        <div class="pagemain">
            <div class="big2">
                <p class="tit">订单&nbsp/&nbsp修改订单</p>
                <hr>
                <form action="#" method="post">
                <c:choose>
                <c:when test="${not empty modifybookinginfo}">
                    <table>
        ...
        orderid
                        ...
                        <td style="width: 40%">
                            <input type="text" name="customid" value="${modifybookinginfo.orderid }">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%">
                            <input type="text" name="customid" value="${modifybookinginfo.customid }">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <input type="text" name="startaddr" value="${modifybookinginfo.startaddr}">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <input type="text" id="sendtime" name="sendtime" value="<fmt:formatDate value="${modifybookinginfo.sendtime }" pattern="yyyy-mm-dd"/>">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <input type="text" name="sendname" value="${modifybookinginfo.sendname }">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <input type="text" name="sendphone" value="${modifybookinginfo.sendphone}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="endaddr" value="${modifybookinginfo.endaddr}">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <input type="text" name="recvname" value="${modifybookinginfo.recvname}">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <input type="text" name="recvphone" value="${modifybookinginfo.recvphone}">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                    ...
                    <tr style="display:none">
                        ...
                        <td>
                            <input type="text" name="statev" value="${modifybookinginfo.statev}">
                        </td>
                    </tr>
                     <tr>
                        <td style="width: 60%;text-align: center">
                        ...
                        <td style="width: 40%;">
                            <textarea style="border:solid 1px" rows="6" cols="40" name="describeo" value="${bookingmodifyinfo.describeo}">
